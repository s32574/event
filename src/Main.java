...
system.makeReservation(concert, customer1);
system.makeReservation(theater, customer2);
system.makeReservation(concert, customer2);
system.makeReservation(theater, customer1);

System.out.println("Reservation for customer"+customer1.getFirstName()+customer1.getLastName()+":");
customer1.displayReservations();
System.out.println("Reservation for customer"+customer2.getFirstName()+customer2.getLastName()+":");
customer2.displayReservations();

Event concertRef= system.findEvent("Symphony Concert");
Event theaterRef= system.findEvent("Hamlet");
